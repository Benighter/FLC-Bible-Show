...
[Registry]
Root: HKCR; Subkey: ".qsch"; ValueType: string; ValueName: ""; ValueData: "FLC Bible Show Schedule"; Flags: uninsdeletevalue
Root: HKCR; Subkey: "FLC Bible Show Schedule"; ValueType: string; ValueName: ""; ValueData: "FLC Bible Show Schedule"; Flags: uninsdeletekey
Root: HKCR; Subkey: "FLC Bible Show Schedule\DefaultIcon"; ValueType: string; ValueName: ""; ValueData: "{app}\icons\logo.ico,0"
Root: HKCR; Subkey: "FLC Bible Show Schedule\shell\open\command"; ValueType: string; ValueName: ""; ValueData: """{app}\FLCBibleShow64.exe"" ""%1"""
